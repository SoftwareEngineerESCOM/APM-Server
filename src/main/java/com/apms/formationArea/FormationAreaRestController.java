...
public class FormationAreaRestController {
    ...
    */
	...
	public RESTResponse<List<FormationArea>> getAll() {
		...
		if (!res.isEmpty()) {
			...
			return new RESTResponse<List<FormationArea>>(RESTResponse.FAIL, "Los catalogos necesarios no se han cargado, favor de intentarlo mas tarde.", null);
		}
	}
    ...
    */
    ...
    public RESTResponse<FormationArea> patch(@RequestBody RESTRequest<FormationArea> formationArea) {
        ...
        return new RESTResponse<FormationArea>(RESTResponse.OK, "Area de formacion modificada.", null);
    }

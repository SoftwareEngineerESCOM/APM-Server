...
public class SubtopicRestController {
	...
	public RESTResponse<List<Subtopic>> getAll() {
		...
		if (!res.isEmpty()) {
			...
			return new RESTResponse<List<Subtopic>>(RESTResponse.FAIL, "Servicios no disponibles.",
					null);
		}
	}
	...
	public RESTResponse<Subtopic> patch(@RequestBody RESTRequest<Subtopic> subtopic) {
		...
		return new RESTResponse<Subtopic>(RESTResponse.OK, "Los cambios se guardaron exitosamente.", null);
	}

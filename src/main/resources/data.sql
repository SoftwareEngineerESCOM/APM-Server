...
Las prácticas se consideran requisito indispensable para acreditar esta unidad de aprendizaje.', true, 'Salas de cómputo de la Escuela.', 27.0, (SELECT id FROM learning_unit WHERE name LIKE 'Ingenieria de software'));
...
insert into practice values (DEFAULT, 4.5, 'Modelos de procesos', 1, (SELECT id FROM thematic_unit WHERE content_id IN (SELECT id FROM content WHERE name LIKE 'Ingeniería de Software')), (SELECT id FROM practice_relation WHERE learning_unit_id = (SELECT id FROM learning_unit WHERE name LIKE 'Ingenieria de software')));
insert into practice values (DEFAULT, 4.5, 'Proceso de gestión de proyecto', 2, (SELECT id FROM thematic_unit WHERE content_id IN (SELECT id FROM content WHERE name LIKE 'Proceso de gestión de proyecto')), (SELECT id FROM practice_relation WHERE learning_unit_id = (SELECT id FROM learning_unit WHERE name LIKE 'Ingenieria de software')));
insert into practice values (DEFAULT, 4.5, 'Uso de las diferentes Metodologías', 3, (SELECT id FROM thematic_unit WHERE content_id IN (SELECT id FROM content WHERE name LIKE 'Metodologías')), (SELECT id FROM practice_relation WHERE learning_unit_id = (SELECT id FROM learning_unit WHERE name LIKE 'Ingenieria de software')));
insert into practice values (DEFAULT, 4.5, 'Listas de verificación usados en las Normas de Calidad', 4, (SELECT id FROM thematic_unit WHERE content_id IN (SELECT id FROM content WHERE name LIKE 'Calidad y normas de calidad')), (SELECT id FROM practice_relation WHERE learning_unit_id = (SELECT id FROM learning_unit WHERE name LIKE 'Ingenieria de software')));

...
-- add study_plan
insert into study_plan (mode, total_practice_hours, totalsatcacredits, totaltepiccredits, total_theory_hours, year, academic_program_id) values ('Escolarizado', 250.0, 30.0, 35.0, 137.0, 2018, (select id from academic_program where name like '%Ingeniería en Sistemas Computacionales%'));
insert into study_plan (mode, total_practice_hours, totalsatcacredits, totaltepiccredits, total_theory_hours, year, academic_program_id) values ('Escolarizado', 234.0, 33.0, 31.0, 137.0, 2018, (select id from academic_program where name like '%Ingeniería en Control y Automatización%'));
insert into study_plan (mode, total_practice_hours, totalsatcacredits, totaltepiccredits, total_theory_hours, year, academic_program_id) values ('A distancia', 240.0, 34.0, 31.0, 133.0, 2018, (select id from academic_program where name like '%Licenciatura en Comercio Internacional%'));
insert into study_plan (mode, total_practice_hours, totalsatcacredits, totaltepiccredits, total_theory_hours, year, academic_program_id) values ('A distancia', 260.0, 32.0, 31.0, 135.0, 2018, (select id from academic_program where name like '%Licenciatura en Física y Matemáticas%'));
insert into study_plan (mode, total_practice_hours, totalsatcacredits, totaltepiccredits, total_theory_hours, year, academic_program_id) values ('Escolarizado', 225.0, 32.0, 31.0, 137.0, 2018, (select id from academic_program where name like '%Ingeniería Mecatrónica%'));
insert into study_plan (mode, total_practice_hours, totalsatcacredits, totaltepiccredits, total_theory_hours, year, academic_program_id) values ('Escolarizado', 250.0, 31.0, 32.0, 132.0, 2018, (select id from academic_program where name like '%Ingeniería Textil%'));
insert into study_plan (mode, total_practice_hours, totalsatcacredits, totaltepiccredits, total_theory_hours, year, academic_program_id) values ('A distancia', 250.0, 30.0, 31.0, 140.0, 2018, (select id from academic_program where name like '%Ingeniería Biotecnológica%'));
insert into study_plan (mode, total_practice_hours, totalsatcacredits, totaltepiccredits, total_theory_hours, year, academic_program_id) values ('Escolarizado', 235.0, 30.0, 33.0, 137.0, 2018, (select id from academic_program where name like '%Ingeniería Química Petrolera%'));
insert into study_plan (mode, total_practice_hours, totalsatcacredits, totaltepiccredits, total_theory_hours, year, academic_program_id) values ('A distancia', 245.0, 31.0, 31.0, 137.0, 2018, (select id from academic_program where name like '%Ingeniería Civil%'));
insert into study_plan (mode, total_practice_hours, totalsatcacredits, totaltepiccredits, total_theory_hours, year, academic_program_id) values ('Escolarizado', 255.0, 31.0, 30.0, 138.0, 2018, (select id from academic_program where name like '%Ingeniería en Sistemas Ambientales%'));
...
-- add human resource
insert into human_resource (first_surname, name, second_surname, position_id, title_id, workplace_id) values ('Chávez', 'Oscar', 'Barrera', (select id from position where abbreviation like '%Dir.%'), (select id from title where abbreviation like '%Dr.%'), (select id from workplace where abbreviation like 'ESCOM'));
insert into human_resource (first_surname, name, second_surname, position_id, title_id, workplace_id) values ('González', 'Emiliano', 'Hinojosa', (select id from position where abbreviation like '%Dir.%'), (select id from title where abbreviation like '%Dr.%'), (select id from workplace where abbreviation like 'UPIITA'));
insert into human_resource (first_surname, name, second_surname, position_id, title_id, workplace_id) values ('Frías', 'Erika', 'Covarrubias', (select id from position where abbreviation like '%Sub. Ac.%'), (select id from title where abbreviation like '%Mtro.%'), (select id from workplace where abbreviation like 'ESCOM'));
insert into human_resource (first_surname, name, second_surname, position_id, title_id, workplace_id) values ('Jiménez', 'Eduardo', 'Hernádez', (select id from position where abbreviation like '%Sub. Ac.%'), (select id from title where abbreviation like '%Dr.%'), (select id from workplace where abbreviation like 'UPIITA'));
insert into human_resource (first_surname, name, second_surname, position_id, title_id, workplace_id) values ('Rojas', 'Arturo', 'Rivas', (select id from position where abbreviation like '%Sub. Ac.%'), (select id from title where abbreviation like '%Mtro.%'), (select id from workplace where abbreviation like 'UPIBI'));
insert into human_resource (first_surname, name, second_surname, position_id, title_id, workplace_id) values ('González', 'Daniela', 'Hernández', (select id from position where abbreviation like '%Doc.%'), (select id from title where abbreviation like '%Mtro.%'), (select id from workplace where abbreviation like 'ESCOM'));
insert into human_resource (first_surname, name, second_surname, position_id, title_id, workplace_id) values ('Figueroa', 'Hugo', 'Bernal', (select id from position where abbreviation like '%Doc.%'), (select id from title where abbreviation like '%Mtro.%'), (select id from workplace where abbreviation like 'ESIME Zacatenco'));
insert into human_resource (first_surname, name, second_surname, position_id, title_id, workplace_id) values ('Castrejón', 'Miguel', 'Sánchez', (select id from position where abbreviation like '%Doc.%'), (select id from title where abbreviation like '%Mtro.%'), (select id from workplace where abbreviation like 'ESFM'));
insert into human_resource (first_surname, name, second_surname, position_id, title_id, workplace_id) values ('Castillo', 'Alejandra', 'Jiménez', (select id from position where abbreviation like '%Doc.%'), (select id from title where abbreviation like '%Lic.%'), (select id from workplace where abbreviation like 'ESIT'));
insert into human_resource (first_surname, name, second_surname, position_id, title_id, workplace_id) values ('Guerra', 'David', 'Vargas', (select id from position where abbreviation like '%Dir.%'), (select id from title where abbreviation like '%Dr.%'), (select id from workplace where abbreviation like 'UPIBI'));
